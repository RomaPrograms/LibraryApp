...
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showList = findViewById(R.id.button_view_list);
        addBook = findViewById(R.id.button_admin_add);
        wipe = findViewById(R.id.button_wipe);
        exit = findViewById(R.id.button_admin_exit);
