...
public class RegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fathersName = findViewById(R.id.editTextFather);
        eMail = findViewById(R.id.editTextEmail);
        eMailRepeat = findViewById(R.id.editTextEmailRep);
        password = findViewById(R.id.editTextPass);
        passwordRepeat = findViewById(R.id.editTextPassRep);

        readersDB = new ReadersDB(this);

        buttonAvatar = this.findViewById(R.id.buttonAvatar);
        buttonRegNew = findViewById(R.id.buttonNewReader);
    ...
    //используется для того, чтобы вернуть результат.
    @Override
