...
public class AdminAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAdd = findViewById(R.id.buttonNewBook);

        textTitle = findViewById(R.id.editTextAddTitle);
        textAuthor = findViewById(R.id.editTextAddAuthor);
        textISBN = findViewById(R.id.editTextAddISBN);
        textLink = findViewById(R.id.editTextAddLink);
        textQuant = findViewById(R.id.editTextAddQuantity);
