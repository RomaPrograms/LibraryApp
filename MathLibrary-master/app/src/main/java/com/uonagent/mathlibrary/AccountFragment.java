...
public class AccountFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        avatar = view.findViewById(R.id.button_avatar);
        name = view.findViewById(R.id.client_name);
        quant = view.findViewById(R.id.client_quant);
    ...
    public class CustomAdapter extends SimpleCursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            TextView isbn = view.findViewById(R.id.isbn_common);
            TextView quant = view.findViewById(R.id.quant_common);
            ...
            ImageView cover = view.findViewById(R.id.cover_common);
            ContextWrapper cw = new ContextWrapper(getActivity().getApplicationContext());
